...
def build():
    ...
    module_section(doc, "5", "文件收取—单门店已匹配数据", [
        ...
        "时间", "合作方ERP", "原始文件名", "当前文件名", "客户门店号", "客户交易处编码", "客户交易处名称", "营业Team", "区域", "营业所", "ACC", "好丽友交易处编码", "好丽友交易处名称", "当前责任人", "最近操作人", "判断说明"
    ...
    module_section(doc, "6", "文件收取—单门店未匹配数据", [
        ...
        "时间", "合作方ERP", "原始文件名", "当前文件名", "客户门店号", "客户交易处编码", "客户交易处名称", "营业Team", "区域", "营业所", "ACC", "好丽友交易处编码", "好丽友交易处名称", "异常说明", "当前责任人", "最近操作人"
    ...
    module_section(doc, "9", "台账与汇总—标准POS明细", [
        ...
        "时间", "合作方ERP", "经销商", "客户门店号", "原始交易出码", "客户门店名称", "TEAM", "区域", "营业所", "ACC", "好丽友交易处编码", "好丽友交易处名称", "客户产品号", "客户产品名称", "客户条形码", "好丽友产品编码", "好丽友条形码", "好丽友产品名称", "销售数量", "销售金额", "成本", "零售单价"
