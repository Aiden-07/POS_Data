const I18n = {
  ...
  krPhrases: {
    ...
    '条未读消息': '개의 읽지 않은 메시지',
    '出现异常': '이상이 발생했습니다',
    '质量检查发现条码冲突，请优先处理': '품질 검사에서 바코드 충돌이 발견되었습니다. 우선 처리해 주세요',
    '今日提报进度偏低': '오늘 제출 진행률이 낮습니다',
    '当前完成率': '현재 완료율',
    '低于计划阈值': '계획 기준보다 낮음',
    '月度汇总已生成': '월간 집계가 생성되었습니다',
    '标准化台账可预览下载': '표준화 원장을 미리보기 및 다운로드할 수 있습니다',
    '切换导航': '내비게이션 전환',
    '退出登录': '로그아웃',
